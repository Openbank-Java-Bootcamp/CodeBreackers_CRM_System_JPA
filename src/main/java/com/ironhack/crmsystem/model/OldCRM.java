...
public class OldCRM {
    ...
    public static void setOpportunityMap(Map<Integer, Opportunity> opportunityMap) {
        OldCRM.opportunityMap = opportunityMap;
    }

    public static void setLeadMap(Map<Integer, Lead> leadMap) {
      
        OldCRM.leadMap = leadMap;
    }
    ...
    //====================== SHOW LEADS =======================
    public void listIdName(OldCRM crm)  {
    ...
    public void leadDetail(Scanner scanner, OldCRM crm)  {
        //Header of the Method
        System.out.println();
